...
- ⏳ **Phase 19**: Bug Fixes & UI Polish — 1/10 done (19.8 seamless list source leak ✅; remaining: preview paragraph bug, model display, custom title bar, resizable panes, drop cap, minimal borders, active icon highlighting, formatting toolbar, VS Code extension research)
