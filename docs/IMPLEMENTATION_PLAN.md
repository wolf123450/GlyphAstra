...
- ⏳ **Phase 19**: Bug Fixes & UI Polish — NOT STARTED (10 items: preview paragraph bug, model display, custom title bar, resizable panes, drop cap, minimal borders, active icon highlighting, seamless list source leak, formatting toolbar, VS Code extension research)
